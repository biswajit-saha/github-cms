<script lang="ts">
	...
	export let user: { name?: string; login?: string; avatar_url?: string };
</script>

<aside class="w-[300px] bg-white absolute h-full shadow-sm">
	<div class="p-5">
		<img class="logo" src="/logo-icon.svg" alt="Logo" />
	</div>
	<Menu />
